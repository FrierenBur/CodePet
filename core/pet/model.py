...
class MoodType(Enum):
    ...
    SAD = "sad"          # 悲伤
    SLEEPY = "sleepy"    # 困倦
    SURPRISED = "surprised"  # <<< --- 添加这一行 ---

# ... (ActionType 和 StateType 枚举以及 PetModel 类保持不变) ...
...
class ActionType(Enum): #
    ...
    TIRED = "tired"        # 疲劳表情
    SURPRISED = "surprised"  # 惊讶 (这个是 ActionType，你的错误是 MoodType)
    REACT = "react"        # 反应
...
class PetModel: #
    ...
    def get_mood_value(self) -> int: #
        ...
        # 如果 MoodType 中加入了 SURPRISED，你可能也想在这里给它一个数值
        # 例如: MoodType.SURPRISED: 75 (可以根据需要调整)
